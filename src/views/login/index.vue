<template>
  <div class="minheight" :style="{ backgroundImage: 'url(' + login_center_bg + ')' }">
    <el-card class="login-form-layout">
      <el-form autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
        <div class="logo-title">
          <img :src="logo" alt="" srcset="" class="login-mall">
          <h2 class="login-title color-main">王者系统管理后台</h2>
        ...
        <el-row >
          <el-col :span="16">
            <div class="grid-contentbg-purple">.</div>
          </el-col>
          <el-col  :span="8">
            <div class="grid-contentpurple-light">忘记密码？</div>
          </el-col>
        </el-row>
      </el-form>
    </el-card>
    ...
    handleLogin() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          // }
          this.loading = true; 
            // this.loginForm.account_id = this.loginForm.username
